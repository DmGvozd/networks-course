...
#### Демонстрация работы
- client.py и server.py
- передавался alice.txt (получен в received.txt)
...
#### Демонстрация работы
- client_duplex.py и server_duplex.py
- передавались alice.txt и bob.txt (получены в received_from_client.txt и received_from_server.txt)
...
- *интегрировано в решение задания Б*
