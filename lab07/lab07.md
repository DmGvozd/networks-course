...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - Если я правильно понял, то в моем случае браузер получил ответ от ресурса о получении 6 сегментов всего лишь в двух ACK-пакетах. Первый – через 4.072059, второй – через 4.073212.
   - Значит:
